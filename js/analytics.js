...
function showConsentBanner() {
  ...
  banner.innerHTML = `
    <span style="color:var(--text-secondary,#aaa)">We use anonymized analytics to improve Wagr. <a href="cookies.html" style="color:var(--orange-500,#ea580c);text-decoration:underline">Learn more</a></span>
